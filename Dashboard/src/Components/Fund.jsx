  ...
  const fetchTransactionHistory = async () => {
    try {
      const response = await axios.get(
        `https://full-stack-stock-monitoring-tool-d7k4.onrender.com/transaction-history/${id}`
      );
  ...
  const handleWithdraw = async () => {
    ...
    try {
      const response = await axios.post(
        `https://full-stack-stock-monitoring-tool-d7k4.onrender.com/withdraw-funds/${id}`,
        {
  ...
  const handlePayment = async () => {
    ...
    try {
      const orderResponse = await axios.post(
        "https://full-stack-stock-monitoring-tool-d7k4.onrender.com/create-order",
        {
          amount: amount * 100,
          currency: "INR",
          receipt: `receipt_${id}`,
        ...
        handler: async (response) => {
          try {
            const verificationResponse = await axios.post(
              `https://full-stack-stock-monitoring-tool-d7k4.onrender.com/verify-payment/${id}`,
              {
