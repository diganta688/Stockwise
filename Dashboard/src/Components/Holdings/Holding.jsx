...
const Holdings = () => {
  ...
  let get = async () => {
    try {
      await axios.get(`https://full-stack-stock-monitoring-tool-d7k4.onrender.com/allHoldings/${id}`).then((res) => {
  ...
  const update =async ()=>{
    const response = await axios.post(
      "https://full-stack-stock-monitoring-tool-d7k4.onrender.com/update-holding",
      {
        data: allHoldings,
      }
    );
