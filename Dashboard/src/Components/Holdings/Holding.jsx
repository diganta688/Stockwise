...
const Holdings = () => {
  ...
  let get = async () => {
    try {
      await axios.get(`https://full-stack-stock-monitoring-tool-9qmj.onrender.com/allHoldings/${id}`).then((res) => {
  ...
  const update =async ()=>{
    const response = await axios.post(
      "https://full-stack-stock-monitoring-tool-9qmj.onrender.com/update-holding",
      {
        data: allHoldings,
      }
    );
