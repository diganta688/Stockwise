...
function Order() {
  ...
  useEffect(() => {
    axios
      .get(`https://full-stack-stock-monitoring-tool-9qmj.onrender.com/allOrders/${id}`)
      .then((res) => {
        if (res.data.success) {
          ...
          orders.forEach((order) => {
            ...
            if (timeDiff >= 24 * 60 * 60 * 1000) {
              axios
                .delete(`https://full-stack-stock-monitoring-tool-9qmj.onrender.com/delete-order/${order._id}`)
                .then(() => {
